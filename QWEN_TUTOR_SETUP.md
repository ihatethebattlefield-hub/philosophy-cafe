...
1. 打开网站任意页面。
2. 点击右下角 **Philosophy AI / 哲学 AI**。
3. **Ask the Guide** 中可以选择英语水平并提问。
4. 点击 **Socratic Standoff / 哲学家对决**，从可折叠列表中选择两位哲学家，输入辩题，然后点击 **Begin the standoff**。

对决会自动生成双方开场陈述、针对对方观点的直接反驳、结辩，以及独立 AI 裁判的评分和胜方判定。网页不会保存辩论内容。
...
- 一场完整的哲学家对决只调用一次 Supabase Edge Function，但后台会调用十一次通义千问（双方各五轮，加一次裁判）。每轮最多 75 个英文单词，但总 token 费用仍会明显高于普通导师问答。
